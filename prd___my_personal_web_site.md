...
**Story 1.2: Content Management (CRUD)**
...
**Story 2.1: Lab-Based Navigation & Layout**
...
**Story 2.2: Interactive Dark-Mode UI**
...
*   **ASSUMPTION:** The "Main Grabber" on the landing page will display a maximum of 3-5 featured items to maintain performance.
